...
#  amount with you. Your task is to find maximum number of toys you can buy with K amount. 
...
# the function toyCount() which takes the integer N, integer K and the array arr[ ] as input 
# parameters and returns the maximum count of toys you can have.
